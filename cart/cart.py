...
class Cart:
    ...
    def add(self, product, quantity=1, override_quantity=False):  # Fixed parameter name
    ...
    def get_total_price(self): #Get the total price of all items in the cart
        return sum(Decimal(item['price']) * item['quantity'] for item in self.cart.values())
    
    def clear(self): #Clear the cart
